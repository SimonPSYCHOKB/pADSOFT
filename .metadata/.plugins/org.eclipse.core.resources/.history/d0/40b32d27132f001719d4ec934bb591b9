...
public class MainTester {
	...
	//Add exercises
	Unit u1 = toodle.createUnit(true, "Unit 1");
	Unit u2 = toodle.createUnit(true, "Unit 2");
	Unit u3 = toodle.createUnit(true, "Unit 3");
	
	toodle.addUnitToCourse(u1, c1);
	toodle.addUnitToCourse(u2, c1);
	toodle.addUnitToCourse(u3, c1);
