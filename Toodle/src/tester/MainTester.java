...
public class MainTester {
	...
	int i =0;
	for (Course c: toodle.getCourses()){
		Note n = new Note("This is note number "+ i, true);
		List<Unit> units =c.getUnits();
	...
	//Create exercises
	t1 = new Exercise(true, new Date(), new Date(LocalDateTime.now().plusDays(10).atZone(ZoneId.systemDefault()).toInstant().toEpochMilli()), 0.3);
	t2 = new Exercise(true, new Date(), new Date(LocalDateTime.now().plusDays(10).atZone(ZoneId.systemDefault()).toInstant().toEpochMilli()), 0.3);
	t3 = new Exercise(true, new Date(), new Date(LocalDateTime.now().plusDays(10).atZone(ZoneId.systemDefault()).toInstant().toEpochMilli()), 0.3);
